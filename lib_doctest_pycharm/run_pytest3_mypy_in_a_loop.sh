...
function upgrade_pytest {
    ...
    pip3 install --upgrade "https://github.com/pytest-dev/pytest.git"
    pip3 install --upgrade "https://github.com/davidraleigh/pytest-pep8.git"
}

function upgrade_mypy {
    clr_green "updating mypy"
    pip3 install --upgrade "https://github.com/python/mypy.git"
}
